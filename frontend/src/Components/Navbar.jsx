...
const Navbar = () => {
    ...
    const getFriendRequests = async () => {
        ...
        const response = fetch("http://localhost:3000/friendrequests", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                ...
                <div class="inline-block">
                    <div class="inline-flex items-center max-w-full">
                        <div class="flex items-center flex-grow-0 flex-shrink pl-2 relative w-96 border rounded-full px-1  py-1" type="button">
                            ...
                            <input class="ml-2 block flex-grow flex-shrink overflow-hidden focus:border-gray-300" placeholder="Start your search" />
                ...
                <div class="flex justify-end items-center relative">
                    ...
                    <div class="flex mr-4 items-center">
                        <a class="inline-block py-2 px-3 hover:bg-gray-200 rounded-full" href="#">
                            <div class="flex items-center relative cursor-pointer whitespace-nowrap">Connect with your Friends</div>
                        </a>
                                ...
                                <div className="absolute right-0 mt-2 w-80 bg-white rounded-md shadow-lg z-10">
                                    <div className="py-1">
                                        {/* {friendRequests.map((request) => (
                                            <div key={request.id} className="flex justify-between items-center px-4 py-2">
                                        ...
                                        <div className="flex justify-between items-center px-4 py-2 mb-1">
                                            ...
                                            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80" className="h-10 w-10 rounded-full mr-4 object-cover object-center" alt="avatar" />
                                            <span className="text-base font-medium text-gray-600">Gokul G Menon</span>
                                            </div>
                                            <div className="flex">
                                                <button
